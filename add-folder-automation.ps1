...
# ini contoh dari penambahan secara langsung
# Semester-6 adalah penyimpanan directory yang anda ingin buat
# sebagai contoh directory cd c:\Kuliah\, maka lanjut ke peintah di atas 